...
int main() {
    ...
    string filepath[3] = {"query1K.csv", "query1KLog.txt"};
...
//            flog<<"lt= "<<lt<<" ll length = "<<ll->NumItem<<endl;
    ...
    cout <<Tda/queryNum << ","<< Tsa/queryNum<<","<<Tll/queryNum<<","<<Tcbt/queryNum
    <<","<<Ttv/queryNum<<","<<Tvec/queryNum<<endl;
    finstant <<Tda/queryNum << ","<< Tsa/queryNum<<","<<Tll/queryNum<<","<<Tcbt/queryNum
             <<","<<Ttv/queryNum<<","<<Tvec/queryNum<<endl;
    flog<<"da depth = "<<da->Depth() << endl;
    delete []reorderrange;
    delete []a;
