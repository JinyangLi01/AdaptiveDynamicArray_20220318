/*
 * repeat point query for 10 times and take average time
 */
#include <iostream>
#include <fstream>
#include <chrono>
...
int main() {
    ...
    for (int lt = 0; lt < operations; lt++) {
        ...
        if ( (lt+1 <= 10) || ((lt+1<=100) && ((lt+1)%10 == 0)) || ((lt+1<=1000) && ((lt+1)%100 == 0))
            ...
            //ll->PrintStructure();
            long long Tsa = 0, Tda = 0, Tll = 0, Ttv = 0, Tcbt=0;
            CurOutputNum ++;
            ...
            finstant <<Tda/repeatNum << ","<< Tsa/repeatNum <<","<< Tll/repeatNum <<","<<Tcbt/repeatNum<<","<< Ttv/repeatNum <<endl;
            cout <<Tda/repeatNum << ","<< Tsa/repeatNum <<","<< Tll/repeatNum <<","<<Tcbt/repeatNum<<","<< Ttv/repeatNum <<endl;
