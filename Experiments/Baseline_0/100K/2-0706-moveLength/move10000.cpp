...
/*
        ...
        if ( (lt+1)%1000 == 0 ) {
            ...
            CurOutputNum ++;
            int start1, end1 = NowTotalNum + 2, start2;
            while (end1 >= NowTotalNum) {
                start1 = RandomInt(1, NowTotalNum-distence-moveLength - 100 );
                end1 = start1 + moveLength - 1;
            }
            start2 = end1 + distence;
    ...
    finstant <<moveLength <<"," <<Tda/moveNum << ","<< Tsa/moveNum<<","<<Tll/moveNum<<","<<Tcbt/moveNum<<","<<Ttv/moveNum<<endl;
