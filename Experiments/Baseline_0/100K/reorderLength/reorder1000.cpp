...
/*
    ...
    finstant << reorderLength<<"," <<Tda/reorderNum << ","<< Tsa/reorderNum<<","<<Tll/reorderNum<<","<<Tcbt/reorderNum<<","<<Ttv/reorderNum<<endl;
