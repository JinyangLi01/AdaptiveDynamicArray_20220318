...
/*
    ...
    finstant << queryLength << "," <<Tda/queryNum << ","<< Tsa/queryNum<<","<<Tll/queryNum<<","<<Tcbt/queryNum<<","<<Ttv/queryNum<<endl;
    flog<<"da depth = "<<da->Depth() << endl;
    delete []reorderrange;
    delete []a;
    flog.close();
