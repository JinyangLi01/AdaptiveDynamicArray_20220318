/*
 * query length = 10, repeat 10 times
 */
#include <iostream>
#include <fstream>
#include <chrono>
...
int main() {
    ...
    string filepath[3] = {"2-0702-query1000.csv", "2-0702-query1000Log.txt"};
  ...
  //  CountedBtree * cbt = NewCBTreeForArray(CbtOrder, iniNum);
    ...
    for (int lt = 0; lt < operations; lt++) {
        ...
        if ( (lt+1 <= 10) || ((lt+1<=100) && ((lt+1)%10 == 0)) || ((lt+1<=1000) && ((lt+1)%100 == 0))
            ...
            finstant <<Tda/10 << ","<< Tsa/10<<","<<Tll/10<<","<<Ttv/10<<endl;
