/*
 * this file is different from asyn3 only that
 * 1. dataset = 10000
 * 2. operations = 10000
 */
#include <iostream>
...
const int iniNum = 10000;
const int danodesize = 10;
...
int main() {
    ...
    try {
        ...
        for (int l = 0; l < numSqlCons; ++l) {
            ...
            sqlconn->pstmtInsert = sqlconn->sqlconnection->prepareStatement("INSERT INTO asyn4 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            sqlconn->pstmtDelete = sqlconn->sqlconnection->prepareStatement("DELETE FROM asyn4 WHERE ID = ?");
        ...
        string filepath[3] = {"asyn4.csv", "asyn4Log.txt"};
