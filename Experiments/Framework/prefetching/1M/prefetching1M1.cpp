...
int main() {
    ...
    try {
        ...
        sql::PreparedStatement* pstmtInsert = con->prepareStatement("INSERT INTO prefetching6 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        sql::PreparedStatement* pstmtDelete = con->prepareStatement("DELETE FROM prefetching6 WHERE ID = ?");
        ...
        string filepath[3] = {"prefetching6.csv", "prefetching6Log.txt"};
