...
/*
            ...
            int * Ansdaodp = daonedp->RangeQuery(1, NowTotalNum, &num);
            ...
            if (!CompareArray(Ansst, Ansdaodp, num)) {
                flag4 =true;
            }
            if (flag4||flag3||flag2||flag1) {
                printf(" ---------------------lt = %d, move not equal: %d %d %d %d\n", lt, flag1, flag2, flag3, flag4);
                //stree->PrintTree();
                break;
            }

            delete []Ansst, delete []Ansdanl, delete []AnsDA, delete []Ansdaodp;
*/
            numUpdate ++;

            long long Tda = 0, Tdanl = 0, Tst = 0, Tdaodp = 0;
            CurOutputNum ++;
            ...
            time1 = timeNow();
            danolimit->RangeQuery(start1, end1, &num);
            time2 = timeNow();
            ...
            time1 = timeNow();
            stree->RangeQuery(start1, end1, &num);
            time2 = timeNow();
