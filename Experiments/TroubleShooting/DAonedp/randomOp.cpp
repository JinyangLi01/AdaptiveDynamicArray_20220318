    ...
    for (int lt = 0; lt < TotalActions; lt++) {
        ...
        switch (a[lt]) {
            ...
            case 4: //reorder
            {
                ...
                daonedp->Reorder(start, end, newArray);
                delete []newArray;
                delete []oldArray;
                break;
            }
        ...
        if ( (lt+1 <= 10) || ((lt+1<=100) && ((lt+1)%10 == 0)) || ((lt+1<=1000) && ((lt+1)%100 == 0))
            ...
            int * Ansdaod = daonedp->RangeQuery(1, NowTotalNum, &num);
            bool flag1 = false, flag2 = false, flag3 = false, flag4 = false;
            if (!CompareArray(AnsDA, Ansdaod, num)) {
                flag1 =true;
            }
            if (flag1) {
            ...
            daonedp->Insert(ToInsert, pos);
            time2 = timeNow();
            Tod = duration(time2 - time1);
            ToInsert++;
            NowTotalNum++;
            finstant <<Tda << ","<< Tdanl<<","<<Tst<< "," << Tod <<endl;
