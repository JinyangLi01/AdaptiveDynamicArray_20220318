...
int main() {
    ...
    string filepath[3] = {"swap1M.csv", "swap1MLog.txt"};
    ...
    for (int lt = 0; lt < operations; lt++) {
        ...
        if ((lt+1)%100000 == 0)
        {
            ...
            finstant << fl << ",";
            int start1 = 10, end1 = 450, start2 = 720, end2 = 810;
            ...
            finstant <<t1 << ","<< t2<<","<<t2<<","<<t3<<endl;
            cout<<"lt = "<< lt <<" da depth = "<<da->Depth()<<endl;
            flog<<"lt= "<<lt<<" ll length = "<<ll->NumItem<<endl;
        }
        numUpdate++;
    } //for lt <= loopTime
    finstant <<Tda/swapNum << ","<< Tsa/swapNum<<","<<Tll/swapNum<<","<< Ttv/swapNum <<endl;
