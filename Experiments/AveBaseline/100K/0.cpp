...
int main() {
    ...
    string filepath[3] = {"../Experiments/AveBaseline/100K/0_instant.csv", "../Experiments/AveBaseline/100K/0_average.csv", "../Experiments/AveBaseline/100K/0_final.csv"};
    ...
    int  QueryActions = operations * 3 / 10;
    int ReorderActions = operations * 1 / 10;
    int SwapActions = operations * 1 / 10;
    int MoveActions = operations * 1 / 10;
