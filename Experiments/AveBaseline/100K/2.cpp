...
int main() {
    ...
    string filepath[3] = {"../Experiments/AveBaseline/100K/2_instant.csv", "../Experiments/AveBaseline/100K/2_average.csv", "../Experiments/AveBaseline/100K/2_final.csv"};
    ...
    int InsertActions = operations * 25 / 1000;
    int DeleteActions = operations * 25 / 1000;
    int QueryActions = operations * 65 / 100;
    int ReorderActions = operations  / 10;
    int SwapActions = operations  / 10;
    int MoveActions = operations  / 10;
