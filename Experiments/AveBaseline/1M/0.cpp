...
int main() {
    ...
    string filepath[3] = {"../Experiments/AveBaseline/1M/0_instant.csv", "../Experiments/AveBaseline/1M/0_average.csv", "../Experiments/AveBaseline/1M/0_final.csv"};
    ...
    std::shuffle(&a[0], &a[TotalActions], g);
